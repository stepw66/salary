...
<div class="">
  <div class="medium-8 columns">
    <h3>ข้าราชการ : กรอกเงินเดือน</h3>
  </div>
  <div class="medium-4 columns">
     {{ Form::open( array( 'url' => 'emptype3/salary-search' ) ) }}
      <div class="row collapse">   
          <div class="large-8 small-9 columns">
            <input type="search" class="search" id="search_salary3" name="search_salary3" placeholder="ค้นหา CID, ชื่อ, นามสกุล"/>
          </div>
   ...
   <div class="large-12 columns">
      ...
      <?php $i=0; ?>
        ...
        <tr> 
          ...
          <td><a  title="แก้ไขข้อมูล" data-reveal-id="ModalSalary3" onclick="ModalSalary3( {{ $a->cid }}, '{{ $a->pname }}', '{{ $a->fname }}', '{{ $a->lname }}' )" href=""><i class="fi-page-edit small"></i></a></td>                        
        </tr> 
        <?php $i++;  ?>
        @endforeach   
  </table>
...
<div id="ModalSalary3" class="reveal-modal" data-reveal>
  <h3>กรอกเงินเดือน : <span id="ModalSalaryTitle3"></span></h3>

  <div id="fromSalary3"></div>
