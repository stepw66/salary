...
<ul class="breadcrumbs">
  ...
  <li class="current"><a href="#">อัพไฟล์ข้อมูลเงินเดือนจากพี่นก</a></li>
</ul>

{{ Form::open( array( 'url' => 'upexcelnth/upload', 'files'=>true ) ) }}
<fieldset>
<h2>อัพไฟล์ข้อมูลเงินเดือนข้าราชการจาก พี่นก</h2>  
