...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="#">รายละเอียดเงินค่าจ้าง (EXCEL)</a></li>
  <li class="current"><a href="#">เลือกช่วงข้อมูล</a></li>
</ul>

{{ Form::open( array( 'url' => 'report/support_excel_day_export', 'data-abide' => '' ) ) }}
<fieldset>
<h2>รายละเอียดเงินค่าจ้าง(รายวัน) เลือกช่วงข้อมูล</h2>  

<div class="row">
	<div class="large-12 columns">
	{{ Form::label( 'level', 'เลือกเดือน :', array( 'class' => 'uk-form-label' ) ) }}		
	    <select id="m6" name="m6" class="">	
