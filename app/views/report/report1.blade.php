...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="#">ส่งข้อมูลพี่ก้อย</a></li>
  <li class="current"><a href="#">(EXCEL)</a></li>
</ul>

{{ Form::open( array( 'url' => 'report/salary_excel_2file', 'data-abide' => '' ) ) }}
<fieldset>
<h2>ส่งข้อมูลพี่ก้อย (EXCEL) เลือกช่วงข้อมูล</h2>  
