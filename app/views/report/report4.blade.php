...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="#">รายงานค่าตอบแทน OT (EXCEL)</a></li>
  <li class="current"><a href="#">เลือกช่วงข้อมูล</a></li>
</ul>

{{ Form::open( array( 'url' => 'report/special_ot_excel_export', 'data-abide' => '' ) ) }}
<fieldset>
<h2>รายงานค่าตอบแทน OT เลือกช่วงข้อมูล</h2>  
