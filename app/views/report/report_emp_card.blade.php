...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="#">สลิป-(ลูกจ้างชั่วคราว/พกส.(ปฏิบัติงาน)) รายคน</a></li>
  <li class="current"><a href="#">เลือกช่วงข้อมูล</a></li>
</ul>

{{ Form::open( array( 'url' => 'report/salary_emp_cid', 'data-abide' => '' ) ) }}
<fieldset>
<h2>สลิป-(ลูกจ้างชั่วคราว/พกส.(ปฏิบัติงาน)) รายคน</h2>  

<div class="row">
	<div class="large-12 columns">
	{{ Form::label( 'level', 'เลือกเดือน :', array( 'class' => 'uk-form-label' ) ) }}		
	    <select  name="m1" class="">	
...
<div class="row">
	<div class="large-12 columns">
        {{ Form::label( 'level', 'รหัสบัตรประชาชน : เช่น cid1 หรือ cid1, cid2, cid3 ', array( 'class' => 'uk-form-label' ) ) }}
