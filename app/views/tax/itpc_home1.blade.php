...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="#">พกส./ลูกจ้างชั่วคราว ภ.ง.ค.1 ก</a></li>
  <li class="current"><a href="#">เลือกช่วงข้อมูล</a></li>
</ul>

{{ Form::open( array( 'url' => 'tax1/itpc', 'data-abide' => '' ) ) }}
<fieldset>
<h2>พกส./ลูกจ้างชั่วคราว ภ.ง.ค.1 ก เลือกช่วงข้อมูล</h2>  
