...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="#">ข้าราชการ หนังสือรับรอง</a></li>
  <li class="current"><a href="#">เลือกช่วงข้อมูล</a></li>
</ul>

{{ Form::open( array( 'url' => 'tax3/continuous_home3_post', 'data-abide' => '' ) ) }}
<fieldset>
<h2>ข้าราชการ หนังสือรับรอง เลือกช่วงข้อมูล</h2>  
