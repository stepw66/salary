...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="#">ใบสรุปรายได้เพื่อหักภาษี ข้าราชการ</a></li>
  <li class="current"><a href="#">เลือกช่วงข้อมูล</a></li>
</ul>

{{ Form::open( array( 'url' => 'tax3/sumsalarytax_pdf', 'data-abide' => '' ) ) }}
<fieldset>
<h2>ใบสรุปรายได้เพื่อหักภาษี ข้าราชการ เลือกช่วงข้อมูล</h2>  
