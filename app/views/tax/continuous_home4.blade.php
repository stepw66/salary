...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="#">พนักงานราชการ หนังสือรับรอง</a></li>
  <li class="current"><a href="#">เลือกช่วงข้อมูล</a></li>
</ul>

{{ Form::open( array( 'url' => 'tax4/continuous_home4_post', 'data-abide' => '' ) ) }}
<fieldset>
<h2>พนักงานราชการ หนังสือรับรอง เลือกช่วงข้อมูล</h2>  

<div class="row">
	<div class="large-12 columns">
	{{ Form::label( 'level', 'เลือกปี :', array( 'class' => 'uk-form-label' ) ) }}		
	   <select name="y3" class=""> 
          @foreach( $data as $a )              
