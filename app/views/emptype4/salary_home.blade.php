...
<div class="">
  <div class="medium-8 columns">
    <h3>ลูกจ้างชั่วคราว : กรอกเงินเดือน</h3>
  </div>
  <div class="medium-4 columns">
     {{ Form::open( array( 'url' => 'emptype4/salary-search' ) ) }}
      <div class="row collapse">   
          <div class="large-8 small-9 columns">
            <input type="search" class="search" id="search_salary4" name="search_salary4" placeholder="ค้นหา CID, ชื่อ, นามสกุล"/>
          </div>
   ...
   <div class="large-12 columns">
      ...
      <?php $i=0; ?>
        ...
        <tr> 
          ...
          <td><a  title="แก้ไขข้อมูล" data-reveal-id="ModalSalary4" onclick="ModalSalary4( {{ $a->cid }}, '{{ $a->pname }}', '{{ $a->fname }}', '{{ $a->lname }}' )" href=""><i class="fi-page-edit small"></i></a></td>                        
        </tr> 
        <?php $i++;  ?>
        @endforeach   
  </table>
...
<div id="ModalSalary4" class="reveal-modal" data-reveal>
  <h3>กรอกเงินเดือน : <span id="ModalSalaryTitle4"></span></h3>

  <div id="fromSalary4"></div>
