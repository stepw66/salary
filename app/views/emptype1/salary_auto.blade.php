...
<ul class="breadcrumbs">
  ...
  <li class="unavailable"><a href="#">พกส - ลูกจ้างชั่วคราว</a></li>
...
<div class="row">
  <div class="small-6 small-centered columns">
    ...
    <hr />
    <a href="#" onclick="emp1_salary_auto()" class="button small">เพิ่มข้อมูลอัตโนมัติ</a>

    <div id="status_addauto_emp1"></div>
  </div>
</div>
